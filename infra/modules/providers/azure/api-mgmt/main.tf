...
resource "azurerm_template_deployment" "apimgmt" {
  ...
  parameters = {
    ...
    "api_hostname_type"                = "${var.api_hostname_type}"
    "api_hostname"                     = "${var.api_hostname}"
    "primary_regional_hostname_type"   = "${var.primary_regional_hostname_type}" 
    "primary_regional_hostname"        = "${var.primary_regional_hostname}" 
    "secondary_regional_hostname_type" = "${var.secondary_regional_hostname_type}"
    "secondary_regional_hostname"      = "${var.secondary_regional_hostname}"
    "portal_hostname_type"             = "${var.portal_hostname_type}"
    "portal_hostname"                  = "${var.portal_hostname}"
    "scm_hostname_type"                = "${var.scm_hostname_type}"
