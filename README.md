...
4. Follow these [instructions](test-harness/README.md) to setup your local environment. Make sure that the repository lives in the following directory: `$GOPATH/src/github.com/microsoft/cobalt/`
