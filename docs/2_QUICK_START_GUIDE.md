...
* From the az-hello-world directory, execute the following commands to orchestrate a deployment.
...
* **Azure Hello World CIT [Main.tf](https://github.com/microsoft/cobalt/blob/master/infra/templates/az-hello-world/main.tf) File**
    ...
    This template is made up of many files. The primary source code that drives this template's deployment lives in the Main.tf file:
...
* From the az-hello-world directory, optionally execute the following command to teardown your deployment and delete your resources.
...
This is a great opportunity to point out that steps 4-6 is effectively the local Cobalt developer workflow. (i.e. create/choose a template ---> init ---> workspace (local or remote) ---> apply ---> plan ---> destroy)
